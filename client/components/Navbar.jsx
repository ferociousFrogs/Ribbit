    ...
    <header className="header">
      <div role="navigation" className="navbar navbar-default navbar-fixed-top">
        <div className="container">
          <div className="navbar-header"><Link to="/" className="navbar-brand scroll-to"><img src="../ribbit.png" alt="logo" className="hidden-xs hidden-sm" /><span className="sr-only">Go to homepage</span></Link>
